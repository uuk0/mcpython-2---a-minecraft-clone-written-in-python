...
class BoxModel(object):
    ...
    def __init__(
        self, length, width, height, image, pixel_length, pixel_width, pixel_height
    ):
        self.image = image

        self.length, self.width, self.height = length, width, height
        self.pixel_length, self.pixel_width, self.pixel_height = (
            pixel_length,
            pixel_width,
            pixel_height,
        )
    ...
    def get_texture_data(self):
        texture_data = []
        texture_data += mathhelper.get_texture_coordinates(
            self.textures[0][0],
            self.textures[0][-1],
            self.pixel_width,
            self.pixel_length,
    ...
    def update_texture_data(self, textures):
        ...
        self.display = pyglet.graphics.vertex_list(
            24,
