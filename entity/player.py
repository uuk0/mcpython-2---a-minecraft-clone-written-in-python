...
imagecutter.cut_image(G.local+"/assets/minecraft/textures/entity/steve.png", (0, 0), (64, 32),
                      G.local+"/tmp/entity/steve.png")
imagecutter.cut_image(G.local+"/assets/minecraft/textures/entity/alex.png", (0, 0), (64, 32),
...
class PlayerEntity(G.entityclass):
    ...
    def __init__(self, position=(0, 0, 0)):
        ...
        self.image = mathhelper.load_image(G.local+"/tmp/entity/"+("steve.png" if config.SKIN == 0 else "alex.png"))
        #self.image = mathhelper.load_image(G.local+"/assets/minecraft/textures/entity/char.png")
        self.head = entity.boxmodel.BoxModel(HEAD_LENGTH, HEAD_WIDTH, HEAD_HEIGHT, self.image, 32, 32, 32)
        self.head.update_texture_data([(32, 96), (64, 96), (0, 64), (64, 64), (32, 64), (96, 64)])
        # body
        self.body = entity.boxmodel.BoxModel(BODY_LENGTH, BODY_WIDTH, BODY_HEIGHT, self.image, 32, 16, 48)
        self.body.update_texture_data([(80, 48), (112, 48), (64, 0), (112, 0), (80, 0), (128, 0)])
        # left/right arm
        self.left_arm = entity.boxmodel.BoxModel(ARM_LENGTH, ARM_WIDTH, ARM_HEIGHT, self.image, 16, 16, 48)
        self.left_arm.update_texture_data(
            [(176, 48), (176 + 16, 48), (176, 0), (176 + 32, 0), (176 - 16, 0), (176 + 16, 0)])
        self.right_arm = entity.boxmodel.BoxModel(ARM_LENGTH, ARM_WIDTH, ARM_HEIGHT, self.image, 16, 16, 48)
        self.right_arm.update_texture_data(
            [(176, 48), (176 + 16, 48), (176, 0), (176 + 32, 0), (176 - 16, 0), (176 + 16, 0)])
        # left/right leg
        self.left_leg = entity.boxmodel.BoxModel(LEG_LENGTH, LEG_WIDTH, LEG_HEIGHT, self.image, 16, 16, 48)
        self.left_leg.update_texture_data([(16, 48), (16 + 16, 48), (0, 0), (32, 0), (16, 0), (48, 0)])
        self.right_leg = entity.boxmodel.BoxModel(LEG_LENGTH, LEG_WIDTH, LEG_HEIGHT, self.image, 16, 16, 48)
        self.right_leg.update_texture_data([(16, 48), (16 + 16, 48), (0, 0), (32, 0), (16, 0), (48, 0)])

        self.update_position(position)

        self.boxmodels = [self.head, self.body, self.left_arm, self.right_arm, self.left_leg, self.right_leg]
